...
--[[
  ...
  -Additionally, ensure that this file is placed in the vscripts/libraries path and that the vscripts/libraries/modifiers/modifier_animation, modifier_animation_translate, modifier_animation_translate_permanent, and modifier_animation_freeze files exist and are in the correct path
  ...
  -This library requires that the "libraries/timers" be present in your vscripts directory.
...
LinkLuaModifier("modifier_animation", "modifiers/modifier_animation", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier("modifier_animation_translate", "modifiers/modifier_animation_translate", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier("modifier_animation_translate_permanent", "modifiers/modifier_animation_translate_permanent", LUA_MODIFIER_MOTION_NONE )
...
function StartAnimation(unit, table)
  ...
  if translate ~= nil then
    if _ANIMATION_TRANSLATE_TO_CODE[translate] == nil then
      print("[ANIMATIONS] ERROR, no translate-code found for '" .. translate .. "'.  This translate may be misspelled or need to be added to the enum manually.")
      return
    end
  ...
  if translate2 ~= nil and _ANIMATION_TRANSLATE_TO_CODE[translate2] == nil then
    print("[ANIMATIONS] ERROR, no translate-code found for '" .. translate2 .. "'.  This translate may be misspelled or need to be added to the enum manually.")
    return
  end
