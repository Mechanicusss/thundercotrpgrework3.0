LinkLuaModifier("modifier_item_warm_mint_tea", "items/item_warm_mint_tea/item_warm_mint_tea", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_warm_mint_tea_buff", "items/item_warm_mint_tea/item_warm_mint_tea", LUA_MODIFIER_MOTION_NONE)
