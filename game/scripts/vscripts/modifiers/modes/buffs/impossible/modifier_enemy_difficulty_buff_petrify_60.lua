LinkLuaModifier("modifier_enemy_difficulty_buff_petrify_60", "modifiers/modes/buffs/impossible/modifier_enemy_difficulty_buff_petrify_60", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_enemy_difficulty_buff_petrify_60_petrified", "modifiers/modes/buffs/impossible/modifier_enemy_difficulty_buff_petrify_60", LUA_MODIFIER_MOTION_NONE)
