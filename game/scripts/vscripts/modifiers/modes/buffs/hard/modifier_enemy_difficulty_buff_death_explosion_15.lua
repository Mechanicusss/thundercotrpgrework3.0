LinkLuaModifier("modifier_enemy_difficulty_buff_death_explosion_15", "modifiers/modes/buffs/hard/modifier_enemy_difficulty_buff_death_explosion_15", LUA_MODIFIER_MOTION_NONE)
