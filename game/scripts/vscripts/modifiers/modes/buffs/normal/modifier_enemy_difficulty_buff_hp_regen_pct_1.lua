LinkLuaModifier("modifier_enemy_difficulty_buff_hp_regen_pct_1", "modifiers/modes/buffs/normal/modifier_enemy_difficulty_buff_hp_regen_pct_1", LUA_MODIFIER_MOTION_NONE)
