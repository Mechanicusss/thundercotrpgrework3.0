modifier_uber_bosses_portal = class({})

function modifier_uber_bosses_portal:OnCreated()
...
function modifier_uber_bosses_portal:OnIntervalThink()
    local parent = self:GetParent()
...
function modifier_uber_bosses_portal:DeclareFunctions()
    return {
        MODIFIER_PROPERTY_MODEL_CHANGE 
    }
end

function modifier_uber_bosses_portal:GetModifierModelChange()
    return "models/props_gameplay/temple_portal001.vmdl"
end

function modifier_uber_bosses_portal:CheckState()
    return {
