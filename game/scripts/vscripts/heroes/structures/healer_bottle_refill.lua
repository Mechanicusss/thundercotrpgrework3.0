LinkLuaModifier("modifier_healer_bottle_refill", "heroes/structures/healer_bottle_refill", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_healer_bottle_refill_cooldown", "heroes/structures/healer_bottle_refill", LUA_MODIFIER_MOTION_NONE)
