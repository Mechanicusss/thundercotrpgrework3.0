LinkLuaModifier("modifier_healer_taste_of_armor", "heroes/structures/healer_taste_of_armor", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_healer_taste_of_armor_effect", "heroes/structures/healer_taste_of_armor", LUA_MODIFIER_MOTION_NONE)
