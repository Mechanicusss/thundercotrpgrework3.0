LinkLuaModifier("hero_akasha_sonic_wave_modifier", "heroes/hero_akasha/sonic_wave", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("hero_akasha_sonic_wave_thinker", "heroes/hero_akasha/sonic_wave", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("hero_akasha_sonic_wave_thinker_animation", "heroes/hero_akasha/sonic_wave", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("hero_akasha_sonic_wave_debuff", "heroes/hero_akasha/sonic_wave", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("hero_akasha_sonic_wave_thinker_scepter", "heroes/hero_akasha/sonic_wave", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("hero_akasha_sonic_wave_thinker_scepter_cd", "heroes/hero_akasha/sonic_wave", LUA_MODIFIER_MOTION_NONE)
