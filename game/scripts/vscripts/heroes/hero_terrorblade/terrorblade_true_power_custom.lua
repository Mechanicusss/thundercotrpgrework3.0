LinkLuaModifier("modifier_terrorblade_true_power_custom", "heroes/hero_terrorblade/terrorblade_true_power_custom", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_terrorblade_true_power_custom_buff_permanent", "heroes/hero_terrorblade/terrorblade_true_power_custom", LUA_MODIFIER_MOTION_NONE)
