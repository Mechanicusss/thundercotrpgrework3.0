function Eat(keys)
	...
	gold = gold + gold * ability:GetAbilityValues("bonus_gold_pct") * 0.01
	...
	ability:ApplyDataDrivenModifier(caster, caster, "modifier_shinobu_eat_oddity_buff", { duration = ability:GetAbilityValues("buff_duration") })
	caster:SetModifierStackCount("modifier_shinobu_eat_oddity_buff", caster, math.floor(target:GetHealth() * ability:GetAbilityValues("buff_health_pct") * 0.01))
