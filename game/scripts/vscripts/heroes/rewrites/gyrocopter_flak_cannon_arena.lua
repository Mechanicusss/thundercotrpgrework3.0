...
LinkLuaModifier("modifier_gyrocopter_flak_cannon_arena", "heroes/rewrites/gyrocopter_flak_cannon_arena", LUA_MODIFIER_MOTION_NONE)
modifier_gyrocopter_flak_cannon_arena = {
...
LinkLuaModifier("modifier_gyrocopter_flak_cannon_arena_scepter", "heroes/rewrites/gyrocopter_flak_cannon_arena", LUA_MODIFIER_MOTION_NONE)
