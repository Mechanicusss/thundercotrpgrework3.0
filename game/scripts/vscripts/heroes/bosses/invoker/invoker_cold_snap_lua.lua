...
LinkLuaModifier( "modifier_invoker_cold_snap_lua", "heroes/bosses/invoker/modifier_invoker_cold_snap_lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_generic_stunned_lua", "modifiers/modifier_generic_stunned_lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_generic_break_lua", "modifiers/modifier_generic_break_lua", LUA_MODIFIER_MOTION_NONE )
