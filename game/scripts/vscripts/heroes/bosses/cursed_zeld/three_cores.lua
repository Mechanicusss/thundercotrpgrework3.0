LinkLuaModifier("modifier_boss_cursed_zeld_three_cores", "heroes/bosses/cursed_zeld/three_cores", LUA_MODIFIER_MOTION_NONE)
		...
		if ability:PerformPrecastActions() then
			...
			elseif effect == 2 then
				ApplyDamage({
					...
					attacker = parent,
					damage = parent:GetHealth() * ability:GetAbilityValues("damage_pct") * 0.01,
