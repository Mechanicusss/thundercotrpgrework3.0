LinkLuaModifier("modifier_sara_space_dissection", "heroes/hero_sara/space_dissection", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_sara_space_dissection_armor_reduction", "heroes/hero_sara/space_dissection", LUA_MODIFIER_MOTION_NONE)
