LinkLuaModifier("modifier_sara_fragment_of_hate", "heroes/hero_sara/fragment_of_hate", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_sara_fragment_of_hate_buff_scepter", "heroes/hero_sara/fragment_of_hate", LUA_MODIFIER_MOTION_NONE)
