LinkLuaModifier("modifier_meat_hook_followthrough_lua", "heroes/hero_pudge/pudge_meat_hook_lua" ,LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_meat_hook_lua", "heroes/hero_pudge/pudge_meat_hook_lua" ,LUA_MODIFIER_MOTION_HORIZONTAL)
LinkLuaModifier("modifier_meat_hook_bloodstained_lua", "heroes/hero_pudge/pudge_meat_hook_lua" ,LUA_MODIFIER_MOTION_NONE)
