function CheckDeath(keys)
	...
	ability.health_per_reincarnation_pct = ability:GetAbilityValues("health_per_reincarnation_pct")
	if caster:HasScepter() then
		ability.health_per_reincarnation_pct = ability:GetAbilityValues("health_per_reincarnation_pct_scepter")
	end
