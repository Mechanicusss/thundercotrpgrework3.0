LinkLuaModifier("modifier_sai_rage_of_pain", "heroes/hero_sai/rage_of_pain", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_sai_rage_of_pain_mass_debuff", "heroes/hero_sai/rage_of_pain", LUA_MODIFIER_MOTION_NONE)
