LinkLuaModifier("modifier_sai_release_of_forge", "heroes/hero_sai/release_of_forge", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_sai_release_of_forge_mass_debuff", "heroes/hero_sai/release_of_forge", LUA_MODIFIER_MOTION_NONE)
