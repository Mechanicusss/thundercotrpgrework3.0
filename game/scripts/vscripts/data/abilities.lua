...
ARENA_NOT_CASTABLE_ABILITIES = {
	["techies_land_mines"] = GetAbilityValues("techies_land_mines", "radius"),
	["techies_stasis_trap"] = GetAbilityValues("techies_stasis_trap", "activation_radius"),
	["techies_remote_mines"] = GetAbilityValues("techies_land_mines", "radius"),
	["invoker_chaos_meteor"] = 1100,
	["disruptor_thunder_strike"] = GetAbilityValues("disruptor_thunder_strike", "radius"),
	["pugna_nether_blast"] = GetAbilityValues("pugna_nether_blast", "radius"),
	["enigma_midnight_pulse"] = GetAbilityValues("enigma_midnight_pulse", "radius"),
	["abyssal_underlord_firestorm"] = GetAbilityValues("abyssal_underlord_firestorm", "radius"),
	["skywrath_mage_mystic_flare"] = GetAbilityValues("skywrath_mage_mystic_flare", "radius"),
}
